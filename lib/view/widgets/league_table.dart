...
class _LeagueTableState extends State<LeagueTable> {
  ...
  Widget build(BuildContext context) {
    ...
    LeagueStandings leagueStandingsModel =
        Provider.of<LeagueStandings>(context);
    final total = leagueStandingsModel.totalList;
    final home = leagueStandingsModel.homeList;
    final away = leagueStandingsModel.awayList;
    return Padding(
